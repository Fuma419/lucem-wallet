...
const logDeprecated = () => {
  console.warn(
    'This Lucem API implementation is deprecated soon. Please follow the API under the window.cardano.lucem namespace. For more information check out CIP-30: https://github.com/cardano-foundation/CIPs/tree/master/CIP-0030'
  );
  return true;
};
